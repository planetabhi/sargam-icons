  ...
  <nav class="top-nav" aria-label="Primary">
    <div class="top-nav-inner">
      <div class="lhs">
        ...
        <span class="version-pill" aria-label="Version">v1.6.6</span>
        
        <label for="icon-search" class="sr-only">Search icons</label>
        <div class="nav-search-wrapper">
          <input id="icon-search" type="search" placeholder="Search icons..." aria-label="Search icons" autocomplete="off" inputmode="search" />
   ...
   <script>
    ...
    function initIconPopover() {
      ...
      function dragStart(e) {
        ...
        const currentTransform = window.getComputedStyle(popoverContent).transform;
        
        if (currentTransform && currentTransform !== 'none') {
          const matrix = currentTransform.match(/matrix\((.+)\)/);
          if (matrix) {
            const values = matrix[1].split(', ');
            currentPosX = parseFloat(values[4]) || 0;
            currentPosY = parseFloat(values[5]) || 0;
          }
        }
