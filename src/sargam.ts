...
const CDN_BASE_URL = 'https://cdn.jsdelivr.net/npm/sargam-icons@1.6.7/Icons/';
...
<body>  
  <nav class="top-nav" aria-label="Primary">
    <div class="top-nav-inner">
      <div class="lhs">
        ...
        <span class="version-pill" aria-label="Version">v1.6.7</span>
  ...
  <footer>
    <div class="footer-content">
      ABHIMANYU RANA 2026 ©<br /> <a href="https://github.com/planetabhi/sargam-icons/blob/main/LICENSE.txt" target="_blank" rel="noopener noreferrer">MIT License</a> &middot; By <a href="https://planetabhi.com/" target="_blank" rel="noopener noreferrer">@PLANETABHI</a> <br /> <a href="https://www.jsdelivr.com/package/npm/sargam-icons"><img src="https://data.jsdelivr.com/v1/package/npm/sargam-icons/badge" alt="jsdelivr package download stats" style="margin: 0 auto; padding-top: 0.5rem; aspect-ratio: auto;"></a>
    </div>
  </footer>
